                ...
                <table cellpadding=3>
                    <tr>
                        ...
                        <td><input id="txtOldPass" type="Password" class="txt01 easyui-validatebox"
                                   data-options="required:true,validType:'length[4,8]'"/></td>
                    </tr>
                    <tr>
                        <td>新&nbsp;&nbsp;密&nbsp;&nbsp;码：</td>
                        ...
                        $('#btnEp').click(function(){
                            ...
                            if(v){
                                ...
                                if(newPassword === rePassword ){
                                    ...
                                    var oldAndNewPwd =oldPassword+'-'+newPassword;
                                    $.post(url,{password:oldAndNewPwd},function (data) {
                                        if("1" === data){
                                            //修改成功
                                            $.messager.alert("提示","修改成功!","info");
                                            $('#editPwdWindow').window('close');
                                        }else if("2"=== data) {
                                            $.messager.alert("提示","旧密码不正确!","error")
                                        }else{
